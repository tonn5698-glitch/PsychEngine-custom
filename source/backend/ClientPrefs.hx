...
class ClientPrefs {
	...
	public static var keyBinds:Map<String, Array<FlxKey>> = [
		...
		// Extra Keys (mania > 4). Defaults from TheZoroForce240 / JS Engine layout.
		// First 4 reuse the main binds so 4K charts stay unchanged.
		'note_ek4'		=> [H],
		'note_ek5'		=> [J],
		'note_ek6'		=> [K],
		'note_ek7'		=> [L],
	...
	public static var gamepadBinds:Map<String, Array<FlxGamepadInputID>> = [
		...
		'note_ek4'		=> [LEFT_STICK_DIGITAL_UP],
		'note_ek5'		=> [LEFT_STICK_DIGITAL_DOWN],
		'note_ek6'		=> [LEFT_STICK_DIGITAL_LEFT],
		'note_ek7'		=> [LEFT_STICK_DIGITAL_RIGHT],
		'note_ek8'		=> [RIGHT_STICK_DIGITAL_UP],
		'note_ek9'		=> [RIGHT_STICK_DIGITAL_DOWN],
		'note_ek10'		=> [RIGHT_STICK_DIGITAL_LEFT],
		'note_ek11'		=> [RIGHT_STICK_DIGITAL_RIGHT],
		'note_ek12'		=> [Y],
		'note_ek13'		=> [X],
		'note_ek14'		=> [A],
		'note_ek15'		=> [B],
